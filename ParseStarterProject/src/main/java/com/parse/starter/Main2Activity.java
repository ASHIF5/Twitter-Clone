                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    tweet.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if( e== null){
                                Toast.makeText(Main2Activity.this, "Tweet Posted", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                Toast.makeText(Main2Activity.this, "Failed! Please try again later", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
